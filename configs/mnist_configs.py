...
def configs():
    parser = argparse.ArgumentParser(description='MAU_test')

    parser.add_argument('--data_train_path', type=str, default='')
    parser.add_argument('--data_val_path', type=str, default='')
    parser.add_argument('--data_test_path', type=str, default='data/mnist_dataset/')
    ...
    parser.add_argument('--model_mode', type=str, default='normal') # load mau_recall.ckpt if 'recall' 
    ...
    parser.add_argument('--pretrained_model', type=str, default='pretrained_models/model.ckpt-69000')
