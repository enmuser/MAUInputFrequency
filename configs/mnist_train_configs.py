...
def configs():
    ...
    parser.add_argument('--max_iterations', type=int, default=210000)
    ...
    parser.add_argument('--pretrained_model', type=str, default='/kaggle/input/movingmnist/model.ckpt-123000')
    parser.add_argument('--perforamnce_dir', type=str, default='/kaggle/working/MAUInputFrequency/results/mau/')
    parser.add_argument('--save_dir', type=str, default='/kaggle/working/MAUInputFrequency/checkpoints/mau/')
    parser.add_argument('--gen_frm_dir', type=str, default='/kaggle/working/MAUInputFrequency/results/mau/')
