...
def configs():
    ...
    parser.add_argument('--max_iterations', type=int, default=280000)
    ...
    parser.add_argument('--pretrained_model', type=str, default='/kaggle/input/movingmnist/model.ckpt-184000')
